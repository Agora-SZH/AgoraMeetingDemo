...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/AgoraFoundation/AgoraFoundation/AgoraFoundation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AgoraLog/AgoraLog.framework"
  install_framework "${PODS_ROOT}/AgoraRte/AgoraRte/AgoraRte.framework"
  install_framework "${PODS_ROOT}/AgoraUIFoundation/AgoraUIFoundation/AgoraUIFoundation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CocoaLumberjack/CocoaLumberjack.framework"
  install_framework "${PODS_ROOT}/FcrCore/FcrCore/FcrCore.framework"
  install_framework "${PODS_ROOT}/FcrUIScene/FcrUIScene/FcrUIScene.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AgoraRtm_OC_Special/AgoraRtmKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AgoraRtm_OC_Special/aosl.framework"
