...
@class AGAnimatedImage;
@protocol AGAnimatedImageViewDebugDelegate;


//
//  An `AGAnimatedImageView` can take an `AGAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface AGAnimatedImageView : UIImageView
...
@property (nonatomic, strong) AGAnimatedImage *animatedImage;
